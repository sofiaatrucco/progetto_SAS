...
public class User {
    ...
    private ArrayList<Workshift> listWorkshiftAvailable;
    ...
    public ArrayList<Workshift> getListWorkshiftAvailable() {
        return listWorkshiftAvailable;
    }

    public void setListWorkshiftAvailable(ArrayList<Workshift> listWorkshiftAvailable) {
        this.listWorkshiftAvailable = listWorkshiftAvailable;
    }

    public boolean isAvailable(Workshift ws) {
        //if (isCook()) return listWorkshiftAvailable.contains(ws);
